...
/***************************************************************************
 * This program is modified to be working with a TCP socket instead of    **
 * Serial Ports in the original one                                       **
 ***************************************************************************
 * Modifier: Sencer Yazici                                                **
 * Contact: senceryazici@gmail.com                                        **
 * Date: 20 June 2020                                                     **
 ***************************************************************************/
...
void MainWindow::createUI()
{
    ...
    // {
    //     ui->lineEditPort->addItem(port.portName());
    // }

    /* Populate baud rate combo box with standard rates */
    // ui->lineEditIPAddr->addItem("1200");
    // ui->lineEditIPAddr->addItem("2400");
    // ui->lineEditIPAddr->addItem("4800");
    // ui->lineEditIPAddr->addItem("9600");
    // ui->lineEditIPAddr->addItem("19200");
    // ui->lineEditIPAddr->addItem("38400");
    // ui->lineEditIPAddr->addItem("57600");
    // ui->lineEditIPAddr->addItem("115200");
    // /* And some not-so-standard */
    // ui->lineEditIPAddr->addItem("128000");
    // ui->lineEditIPAddr->addItem("153600");
    // ui->lineEditIPAddr->addItem("230400");
    // ui->lineEditIPAddr->addItem("256000");
    // ui->lineEditIPAddr->addItem("460800");
    // ui->lineEditIPAddr->addItem("921600");

    // /* Select 115200 bits by default */
    // ui->lineEditIPAddr->setCurrentIndex(7);
...
void MainWindow::portOpenedFail()
{
    ...
    ui->statusBar->showMessage("Server cannot be started!");
}
/** ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
...
void MainWindow::readData()
{
    ...
    {                                            // If any bytes are available
        QByteArray data = clientSocket->readAll(); // Read all data in QByteArray
...
void MainWindow::on_actionConnect_triggered()
{
    ...
    {
        ui->statusBar->showMessage("Server Starting!");
...
void MainWindow::on_actionDisconnect_triggered()
{
    if (connected)
    {
        clientSocket->close();  // Close serial port
        emit portClosed();    // Notify application
        delete clientSocket;    // Delete the pointer
        clientSocket = nullptr; // Assign NULL to dangling pointer

        serverSocket->close();
        delete serverSocket;
        serverSocket = nullptr;

        ui->statusBar->showMessage("Server shutdown!");
